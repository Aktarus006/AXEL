...
<div class="w-full h-1/5 bg-white text-slate-900 flex">
    ...
    <div class="w-1/5 flex flex-col justify-between">
        ...
        <div class="border border-x-0 border-1 border-slate-900 hover:underline flex h-1/3 items-center justify-center">COLLABORATIONS</div>
    </div>
    <div class="w-1/5 flex flex-col justify-between">
        <div class="flex items-center justify-center hover:bg-slate-900 hover:text-white h-full border border-1 border-b-0 border-slate-900">ABOUT</div>
