...
<div class="relative w-full py-12 overflow-hidden bg-black border-t-8 border-b-8 border-white group">
    ...
    <div class="absolute w-20 h-20 md:w-36 md:h-36 transition-all duration-1000 -translate-y-1/2 border-4 md:border-8 border-white left-6 md:left-16 top-1/2 group-hover:border-red-700 rotate-45 group-hover:rotate-[225deg] flex items-center justify-center">
        <!-- Inner Facet -->
