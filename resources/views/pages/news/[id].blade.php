...
@if($article)
    @push('head')
        ...
        @if($article->hasMedia('news/images'))
            <meta property="og:image" content="{{ $article->getFirstMediaUrl('news/images', 'large') }}">
        @endif
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="grid grid-cols-1 gap-4">
                                        ...
                                        <a href="https://www.instagram.com/axel.englebert/" target="_blank" class="group flex items-center gap-4 p-4 border-4 border-black hover:bg-black transition-all">
                                            ...
                                            <span class="font-black group-hover:text-white uppercase text-xs">SUIVRE SUR INSTAGRAM</span>
                                        </a>
                                    </div>
                                </div>
