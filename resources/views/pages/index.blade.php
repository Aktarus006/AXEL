<x-layouts.app>
    ...
    <section id="about">
    <div class="relative w-full bg-black border-t-8 border-b-8 border-white mt-24 py-4 group">
    <div class="absolute inset-0 border-t-4 border-b-4 border-black opacity-0 group-hover:opacity-100 transition-opacity"></div>
